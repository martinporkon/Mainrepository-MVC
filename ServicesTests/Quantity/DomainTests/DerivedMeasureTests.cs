...
namespace ServicesTests.Quantity.DomainTests
{
    ...
    [TestClass] public class DerivedMeasureTests : SealedTests<DerivedMeasure, Measure> {
        ...
        [TestMethod] public void DivideByDerivedTest() {
            var d = GetRandom.Object<MeasureData>();
        ...
        [TestMethod] public void MultiplyByDerivedTest() {
            var d = GetRandom.Object<MeasureData>();
            d.MeasureType = MeasureType.Derived;
            new derivedMeasureTestData(obj).add();
            var m = new DerivedMeasure(d);
        ...
        [TestMethod] public void PowerZeroTest() {
            new derivedMeasureTestData(obj).add();
            o = obj.Power(0);
            expectedShort = Word.UnSpecified;
            expectedLong = Word.UnSpecified;
        ...
        //        await terms.Add(new MeasureTerm(d));
        //    }

        //    var t = isReadOnlyProperty(obj, nameof(obj.Terms)) as IReadOnlyList<MeasureTerm>;
        //    Assert.IsNotNull(t);
