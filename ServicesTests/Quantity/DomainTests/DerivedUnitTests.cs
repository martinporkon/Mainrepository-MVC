...
namespace ServicesTests.Quantity.DomainTests
{
    ...
    public class DerivedUnitTests : SealedTests<DerivedUnit, Unit>
    {
        ...
        private UnitTermsRepository terms;
        ...
        public override void TestInitialize()
        {
            ...
            terms = GetRepository.Instance<IUnitTermsRepository>() as UnitTermsRepository;
        ...
        //        terms.Add(new UnitTerm(d)).GetAwaiter();
        //    }

        //    var t = isReadOnlyProperty(obj, nameof(obj.Terms)) as IReadOnlyList<UnitTerm>;
        //    Assert.IsNotNull(t);
