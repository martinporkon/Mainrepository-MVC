...
namespace Catalog.Infra.Quantity
{
    public class QuantityDbContext : DbContext
    {
        ...
        public static void InitializeTables(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductsOfPartyData>().ToTable(nameof(ProductsOfParties))
                .HasKey(x => new { x.ProductId, x.PartyId });
        }
    }
}